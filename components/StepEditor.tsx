                                ...
                                <div className="space-y-3">
                                    ...
                                    <div
                                        className={cn(
                                            ...
                                            dragActive['batch'] ? "border-brand-500 bg-brand-500/10" : "border-white/10 hover:border-brand-500/50"
                                        )}
                                        onDragOver={(e) => { e.preventDefault(); e.stopPropagation(); setDragActive(prev => ({ ...prev, batch: true })); }}
                                        onDragLeave={(e) => { e.preventDefault(); e.stopPropagation(); setDragActive(prev => ({ ...prev, batch: false })); }}
                                        onDrop={(e) => {
                                            e.preventDefault(); e.stopPropagation();
                                            setDragActive(prev => ({ ...prev, batch: false }));
                                    ...
                                    >
                                        ...
                                        <label htmlFor="batch-upload" className="cursor-pointer flex flex-col items-center gap-2">
                                            <FolderOpen className={cn("w-8 h-8", dragActive['batch'] ? "text-brand-400" : "text-slate-500")} />
                                            <span className="text-sm text-slate-400">点击选择或拖拽多张图片</span>
                                            <span className="text-xs text-slate-600">支持批量拖拽</span>
                                        </label>
                                    </div>
